...
switch (argument0)
{
	...
	break;
	case Keys.Jump:
		return gamepad_button_check_pressed(argument1, gp_face1);
	break;
	case Keys.Att:
		return gamepad_button_check_pressed(argument1, gp_face3);
	break;
	case Keys.Start:
		return gamepad_button_check_pressed(argument1, gp_start);
	break;
}